                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th
                                        scope="col"
                                        class="relative py-3.5 pl-3 pr-4"
                                    >
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                ...
                                >
                                    ...
                                    <td
                                        class="px-3 py-4 text-sm text-gray-500 max-w-md truncate"
                                    >
                                        <button
                                        ...
                                        <select
                                            ...
                                            :class="{
                                                ...
                                                'bg-green-50 text-green-700 border-green-300':
                                                    message.status ===
                                                    'completado',
                                                'bg-red-400 text-red-00 border-red-300':
                                                    message.status === 'spam',
                                            }"
                                        >
                                            <option value="nuevo">Nuevo</option>
