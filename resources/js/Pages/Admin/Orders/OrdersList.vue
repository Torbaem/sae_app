        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <!-- Vista móvil para Resumen de Órdenes -->
                    <div class="md:hidden space-y-4">
                        ...
                        >
                            ...
                            <div class="space-y-2">
                                <span class="text-sm text-gray-500"
                                    >Estado de Envío</span
                                >
                                <select
                                    v-model="order.shipping_status"
                                    @change="
                                        updateShippingStatus(order.id, $event)
                                    "
                                    :class="{
                                        'block w-full pl-3 pr-10 py-2 text-sm rounded-md': true,
                                        'bg-yellow-50 text-yellow-700 border-yellow-300':
            ...
            <div class="bg-white rounded-lg shadow">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <!-- Vista móvil para Detalles de Órdenes -->
                        ...
                        >
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <button
                                        @click="
                                            openAddressModal(order.user_address)
                                        "
                                        class="inline-flex items-center px-3 py-1 border border-transparent text-sm leading-4 font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                    >
                                        Ver dirección completa
                                ...
                                <div class="mt-3 text-center sm:mt-5">
                                    ...
                                    <div class="mt-2 text-left">
                                        <div class="space-y-2">
                                            ...
                                            <p
                                                v-if="selectedAddress?.address2"
                                                class="text-sm text-gray-500"
                                            >
                                                <span
                                                    class="font-bold text-black underline"
                                                    >Dirección adicional:</span
                                                >
...
const displayedOrders = computed(() => {
    return props.orders.filter((order) => {
        const matchesId =
            !activeFilters.value.orderId ||
            order.id
                .toString()
                .includes(activeFilters.value.orderId.toString());

        const matchesStatus =
            !activeFilters.value.shippingStatus ||
...
const updateShippingStatus = (orderId, event) => {
    router.put(
        `/admin/orders/${orderId}/shipping-status`,
        {
